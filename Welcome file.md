...
## 一、目标概述
本作业基于TCGA数据库的真实PCPG癌症研究数据，通过设计创新性编程练习，深化Shell、Python与R语言的基础及应用编程技能。核心在于技术实践，可以用于全方位考查运用三种编程语言解决数据处理挑战的能力。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MDY0OTM3MDAsMjIwNjcxNjk3XX0=
-->